...
public interface FiniteStateMachine {
	 ...
	 * @throws FsmException
	 */
	boolean isValidEvent(StateContext stateContext, Event event) throws FsmException;
	 ...
	 * @throws FsmException
	 */
	Collection<Event> getValidEvents(StateContext stateContext) throws FsmException;
}